...
> PriceCandlesPage priceCandles(itemId, marketHashName, phase, start, end, lookback, interval, fill, currency)
...
async function example() {
  ...
  const body = {
    ...
    // string | Lookback window in days. Use `7d` or plain `7`; both mean 7 days and set start=now-lookback. Free tiers cap this at 30 days. (optional)
    lookback: 7d,
...
| **lookback** | `string` | Lookback window in days. Use &#x60;7d&#x60; or plain &#x60;7&#x60;; both mean 7 days and set start&#x3D;now-lookback. Free tiers cap this at 30 days. | [Optional] [Defaults to `undefined`] |
