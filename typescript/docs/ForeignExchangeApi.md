...
|------------- | ------------- | -------------|
| [**getFxRatesV1FxGet**](ForeignExchangeApi.md#getfxratesv1fxget) | **GET** /v1/fx | Get Fx Rates |



## getFxRatesV1FxGet

> FXRatesResponse getFxRatesV1FxGet()
...
import type { GetFxRatesV1FxGetRequest } from 'cs2cap-sdk';
...
async function example() {
  ...
  try {
    const data = await api.getFxRatesV1FxGet();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
