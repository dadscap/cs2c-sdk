...
|------------- | ------------- | -------------|
| [**getMarketIdsV1ItemsMarketIdsGet**](ItemsApi.md#getmarketidsv1itemsmarketidsget) | **GET** /v1/items/market-ids | Get Market Ids |
| [**listItemsV1ItemsGet**](ItemsApi.md#listitemsv1itemsget) | **GET** /v1/items | List Items |



## getMarketIdsV1ItemsMarketIdsGet

> MarketIdsResponse getMarketIdsV1ItemsMarketIdsGet()
...
import type { GetMarketIdsV1ItemsMarketIdsGetRequest } from 'cs2cap-sdk';
...
async function example() {
  ...
  try {
    const data = await api.getMarketIdsV1ItemsMarketIdsGet();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ListItemsV1ItemsGetRequest } from 'cs2cap-sdk';
...
async function example() {
  ...
  const body = {
    ...
    offset: 56,
  } satisfies ListItemsV1ItemsGetRequest;

  try {
    const data = await api.listItemsV1ItemsGet(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
