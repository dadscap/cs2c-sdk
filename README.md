...
| --- | --- | --- |
| Python | `cs2cap-py` (GitHub Packages) | `pip install cs2cap-py --index-url https://pypi.pkg.github.com/CS2Cap/simple/` |
...
```bash
pip install cs2cap-py --index-url https://pypi.pkg.github.com/CS2Cap/simple/
```
