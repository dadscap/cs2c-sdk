...
[**reset_free_tier_ip_binding**](AccountAPIKeysApi.md#reset_free_tier_ip_binding) | **POST** /v1/account/key/reset-ip | Reset Free Tier Ip Binding
...
# **reset_free_tier_ip_binding**
> IPResetResponse reset_free_tier_ip_binding()
...
with cs2cap_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Reset Free Tier Ip Binding
        api_response = api_instance.reset_free_tier_ip_binding()
        print("The response of AccountAPIKeysApi->reset_free_tier_ip_binding:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAPIKeysApi->reset_free_tier_ip_binding: %s\n" % e)
```
