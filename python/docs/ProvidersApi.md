...
------------- | ------------- | -------------
[**list_providers_v1_providers_get**](ProvidersApi.md#list_providers_v1_providers_get) | **GET** /v1/providers | List Providers


# **list_providers_v1_providers_get**
> Dict[str, ProviderInfo] list_providers_v1_providers_get(provider=provider)
...
with cs2cap_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Providers
        api_response = api_instance.list_providers_v1_providers_get(provider=provider)
        print("The response of ProvidersApi->list_providers_v1_providers_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->list_providers_v1_providers_get: %s\n" % e)
```
