...
------------ | ------------- | ------------- | -------------
**code** | **str** | Stable machine-readable error code | [optional] [default to 'VALIDATION_ERROR']
**detail** | [**List[ValidationErrorItem]**](ValidationErrorItem.md) | List of field-level validation errors. | 
