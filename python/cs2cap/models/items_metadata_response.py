...
class ItemsMetadataResponse(BaseModel):
    """
    ItemsMetadataResponse
    """ # noqa: E501
    catalog: ItemsCatalogSummary = Field(description="Catalog summary information.")
    filters: ItemsFilterMetadata = Field(description="Available filter metadata.")
    __properties: ClassVar[List[str]] = ["catalog", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catalog": ItemsCatalogSummary.from_dict(obj["catalog"]) if obj.get("catalog") is not None else None,
            "filters": ItemsFilterMetadata.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
