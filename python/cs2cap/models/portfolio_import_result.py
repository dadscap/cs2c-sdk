...
class PortfolioImportResult(BaseModel):
    ...
    """ # noqa: E501
    imported: StrictInt = Field(description="Items added to the portfolio.")
    skipped: StrictInt = Field(description="Items already present in the portfolio (by asset ID) — not re-added.")
    unresolved: List[StrictStr] = Field(description="market_hash_name values that could not be matched to the CS2C catalog. These items were not imported.")
    __properties: ClassVar[List[str]] = ["imported", "skipped", "unresolved"]
