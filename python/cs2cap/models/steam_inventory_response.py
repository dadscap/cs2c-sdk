...
class SteamInventoryResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[SteamInventoryItem] = Field(description="Items in the inventory.")
    total_count: StrictInt = Field(description="Total inventory count reported by Steam.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SteamInventoryItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
