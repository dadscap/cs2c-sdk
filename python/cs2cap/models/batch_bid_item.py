...
class BatchBidItem(BaseModel):
    ...
    quotes: List[BatchBidQuote] = Field(description="Per-provider bid quotes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phase": obj.get("phase"),
            "quotes": [BatchBidQuote.from_dict(_item) for _item in obj["quotes"]] if obj.get("quotes") is not None else None
        })
        return _obj
