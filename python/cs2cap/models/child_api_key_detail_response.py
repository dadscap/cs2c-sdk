...
class ChildAPIKeyDetailResponse(BaseModel):
    """
    One child key plus current-month usage summary.
    """ # noqa: E501
    key: APIKeyInfo = Field(description="Child API key metadata.")
    requests_this_month: StrictInt = Field(description="Current-month request count for this child key.")
    __properties: ClassVar[List[str]] = ["key", "requests_this_month"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": APIKeyInfo.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "requests_this_month": obj.get("requests_this_month")
        })
        return _obj
