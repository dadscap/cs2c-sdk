...
class PortfolioHistoryPage(BaseModel):
    """
    Response envelope for GET /v1/portfolio/{portfolio_id}/history.
    """ # noqa: E501
    meta: PortfolioHistoryMeta = Field(description="Response metadata.")
    data: List[PortfolioHistoryPoint] = Field(description="Ordered daily valuation points.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": PortfolioHistoryMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [PortfolioHistoryPoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
