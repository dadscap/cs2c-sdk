...
class PortfolioListResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[PortfolioOut] = Field(description="User's portfolios.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PortfolioOut.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
