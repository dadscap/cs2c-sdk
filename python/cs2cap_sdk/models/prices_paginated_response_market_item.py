...
class PricesPaginatedResponseMarketItem(BaseModel):
    """
    PricesPaginatedResponseMarketItem
    """ # noqa: E501
    meta: PricesMeta = Field(description="Response metadata for this payload.")
    items: List[MarketItem] = Field(description="List of returned items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [MarketItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
