...
class PortfolioAddItemRequest(BaseModel):
    ...
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Number of units to add.")
    __properties: ClassVar[List[str]] = ["item_id", "market_hash_name", "phase", "quantity"]
