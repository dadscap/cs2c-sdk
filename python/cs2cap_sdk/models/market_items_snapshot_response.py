...
class MarketItemsSnapshotResponse(BaseModel):
    """
    Response envelope for /v1/market/items.
    """ # noqa: E501
    meta: MarketMeta = Field(description="Response metadata for this payload.")
    data: MarketItemsSnapshotData = Field(description="Primary data payload for this response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": MarketItemsSnapshotData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
