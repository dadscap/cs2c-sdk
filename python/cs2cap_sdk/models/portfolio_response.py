...
class PortfolioResponse(BaseModel):
    ...
    """ # noqa: E501
    meta: PortfolioMeta = Field(description="Response metadata.")
    data: PortfolioData = Field(description="Valuation data.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": PortfolioMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": PortfolioData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
