...
class ChildAPIKeyListResponse(BaseModel):
    """
    Paginated child-key listing.
    """ # noqa: E501
    keys: List[ChildAPIKeyDetailResponse] = Field(description="Child API keys.")
    pagination: PaginationMeta = Field(description="Offset pagination metadata.")
    __properties: ClassVar[List[str]] = ["keys", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [ChildAPIKeyDetailResponse.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None,
