...
class WebhookDeliveriesResponse(BaseModel):
    ...
    """ # noqa: E501
    deliveries: List[WebhookDeliverySummary] = Field(description="Webhook delivery jobs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deliveries": [WebhookDeliverySummary.from_dict(_item) for _item in obj["deliveries"]] if obj.get("deliveries") is not None else None,
