...
class WebhookEndpointsResponse(BaseModel):
    ...
    """ # noqa: E501
    webhooks: List[WebhookEndpointSummary] = Field(description="Configured webhook destinations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [WebhookEndpointSummary.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
