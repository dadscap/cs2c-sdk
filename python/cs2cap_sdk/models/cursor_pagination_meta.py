...
class CursorPaginationMeta(BaseModel):
    ...
    """ # noqa: E501
    limit: Annotated[int, Field(le=1000, strict=True, ge=1)] = Field(description="Items returned per page.")
    has_next: StrictBool = Field(description="Whether another page can be requested with `next_cursor`.")
    has_prev: StrictBool = Field(description="Whether this response was derived from a cursor-aware follow-up request.")
    next_cursor: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["limit", "has_next", "has_prev", "next_cursor"]
