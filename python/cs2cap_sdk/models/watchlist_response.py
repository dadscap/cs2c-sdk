...
class WatchlistResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[WatchlistItem] = Field(description="Saved watchlist entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [WatchlistItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
