...
class WatchlistCreateBatchRequest(BaseModel):
    """
    WatchlistCreateBatchRequest
    """ # noqa: E501
    item_ids: Annotated[List[StrictInt], Field(min_length=1)] = Field(description="Normalized catalog item IDs to save to the watchlist in one request.")
