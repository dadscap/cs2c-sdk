...
class PortfolioRequest(BaseModel):
    ...
    """ # noqa: E501
    items: Annotated[List[PortfolioRequestItem], Field(min_length=1)] = Field(description="Items and quantities to value.")
    currency: Optional[StrictStr] = Field(default='USD', description="Target currency code.")
    providers: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["items", "currency", "providers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PortfolioRequestItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
