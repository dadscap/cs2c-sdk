...
class BatchPriceItem(BaseModel):
    ...
    quotes: List[BatchPriceQuote] = Field(description="Per-provider price quotes.")
    __properties: ClassVar[List[str]] = ["item_id", "market_hash_name", "phase", "quotes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phase": obj.get("phase"),
            "quotes": [BatchPriceQuote.from_dict(_item) for _item in obj["quotes"]] if obj.get("quotes") is not None else None
        })
        return _obj
