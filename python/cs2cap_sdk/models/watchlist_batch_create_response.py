...
class WatchlistBatchCreateResponse(BaseModel):
    """
    WatchlistBatchCreateResponse
    """ # noqa: E501
    items: List[WatchlistItem] = Field(description="Watchlist entries created by this request.")
    created_count: StrictInt = Field(description="Number of watchlist entries created.")
    __properties: ClassVar[List[str]] = ["items", "created_count"]
