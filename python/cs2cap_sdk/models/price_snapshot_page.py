...
class PriceSnapshotPage(BaseModel):
    """
    Paginated price snapshots for raw mode.
    """ # noqa: E501
    meta: PriceHistoryMeta = Field(description="Response metadata for this payload.")
    items: List[PriceSnapshot] = Field(description="List of returned items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": PriceHistoryMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "items": [PriceSnapshot.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
