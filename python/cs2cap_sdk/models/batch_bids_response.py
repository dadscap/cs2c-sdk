...
class BatchBidsResponse(BaseModel):
    """
    Response envelope for POST /v1/bids/batch.
    """ # noqa: E501
    meta: BatchBidsMeta = Field(description="Response metadata.")
    items: List[BatchBidItem] = Field(description="Per-item bid data.")
    items_not_found: List[StrictInt] = Field(description="Item IDs with no bid data available.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": BatchBidsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "items": [BatchBidItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
