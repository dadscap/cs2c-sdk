...
class ItemsCatalogSummary(BaseModel):
    """
    ItemsCatalogSummary
    """ # noqa: E501
    total_items: StrictInt = Field(description="Total number of catalog items currently available.")
    __properties: ClassVar[List[str]] = ["total_items"]
