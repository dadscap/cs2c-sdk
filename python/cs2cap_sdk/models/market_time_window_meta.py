...
class MarketTimeWindowMeta(BaseModel):
    ...
    """ # noqa: E501
    timeframe: StrictStr = Field(description="Liquidity scoring horizon used for this query. Controls which depletion volume window (24h, 7d, or 30d) feeds the liquidity volume score. Does not affect price change fields, bid/ask values, spread, or trade counts.")
