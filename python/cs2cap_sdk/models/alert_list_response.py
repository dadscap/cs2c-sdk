...
class AlertListResponse(BaseModel):
    ...
    """ # noqa: E501
    alerts: List[AlertDefinition] = Field(description="Configured alert rules.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alerts": [AlertDefinition.from_dict(_item) for _item in obj["alerts"]] if obj.get("alerts") is not None else None
        })
        return _obj
