...
class PortfolioOut(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Portfolio UUID.")
    name: StrictStr = Field(description="Display name.")
    item_count: StrictInt = Field(description="Number of items currently in the portfolio.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "item_count", "created_at", "updated_at"]
