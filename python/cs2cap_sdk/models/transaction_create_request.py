...
class TransactionCreateRequest(BaseModel):
    ...
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Number of units.")
    price: Annotated[int, Field(strict=True, ge=0)] = Field(description="Per-unit price in minor units (e.g. USD cents).")
    var_date: date = Field(description="Transaction date (YYYY-MM-DD).", alias="date")
    ...
    currency: Optional[Annotated[str, Field(strict=True, max_length=8)]] = Field(default='USD', description="Currency code.")
    __properties: ClassVar[List[str]] = ["item_id", "market_hash_name", "phase", "type", "quantity", "price", "date", "fee_amount", "fee_percentage", "marketplace", "note", "currency"]
