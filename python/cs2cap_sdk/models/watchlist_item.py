...
class WatchlistItem(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for this saved entry.")
    ...
    created_at: datetime = Field(description="ISO 8601 UTC timestamp when this entry was created.")
    __properties: ClassVar[List[str]] = ["id", "item_id", "market_hash_name", "phase", "created_at"]
