...
class MarketIntelligenceApi:
    ...
    def get_arbitrage_opportunities(
        ...
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Requested offset into the ranked opportunity list.")] = None,
        ...
        providers_sell: Annotated[Optional[List[BuyOrderProvider]], Field(description="Sell-side provider key enum filters for providers with buy orders (plural parameter). Repeat `providers_sell` to pass multiple values.")] = None,
        ...
        :type limit: int
        :param offset: Requested offset into the ranked opportunity list.
        :type offset: int
        ...
        :param providers_sell: Sell-side provider key enum filters for providers with buy orders (plural parameter). Repeat `providers_sell` to pass multiple values.
        :type providers_sell: List[BuyOrderProvider]
        ...
        _param = self._get_arbitrage_opportunities_serialize(
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_arbitrage_opportunities_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Maximum number of results to return. Defaults to the effective tier cap.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Requested offset into the ranked opportunity list.")] = None,
        min_spread_pct: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Minimum gross spread percentage between buy and sell prices.")] = None,
    ...
    @validate_call
    def get_arbitrage_opportunities_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Maximum number of results to return. Defaults to the effective tier cap.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Requested offset into the ranked opportunity list.")] = None,
        min_spread_pct: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Minimum gross spread percentage between buy and sell prices.")] = None,
    ...
    def _get_arbitrage_opportunities_serialize(
        self,
        limit,
        offset,
        min_spread_pct,
    ...
    def get_item_analytics(
        ...
        _param = self._get_item_analytics_serialize(
            item_id=item_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_item_analytics_with_http_info(
        self,
        item_id: Annotated[StrictInt, Field(description="Item ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_item_analytics_without_preload_content(
        self,
        item_id: Annotated[StrictInt, Field(description="Item ID.")],
        _request_timeout: Union[
            None,
    ...
    def _get_item_analytics_serialize(
        self,
        item_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_market_analytics_snapshot(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_market_analytics_snapshot_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MarketItemsSnapshotResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '429': "ErrorResponse",
            '422': "ValidationErrorResponse",
    ...
    @validate_call
    def get_market_analytics_snapshot_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_market_analytics_snapshot_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_market_analytics_snapshot_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
