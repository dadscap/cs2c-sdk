...
class ProvidersApi:
    ...
    def list_providers_v1_providers_get(
        self,
        provider: Annotated[Optional[StrictStr], Field(description="Optional provider key filter (e.g. \"skinport\"). Omit to return all providers.")] = None,
        ...
        :param provider: Optional provider key filter (e.g. \"skinport\"). Omit to return all providers.
        :type provider: str
    ...
    def list_providers_v1_providers_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Dict[str, ProviderInfo]]:
        """List Providers
