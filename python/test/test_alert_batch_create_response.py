...
class TestAlertBatchCreateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AlertBatchCreateResponse:
        """Test AlertBatchCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertBatchCreateResponse`
        """
        model = AlertBatchCreateResponse()
        if include_optional:
            return AlertBatchCreateResponse(
                created = 56,
                failed = 56,
                results = [
    ...
    def testAlertBatchCreateResponse(self):
        """Test AlertBatchCreateResponse"""
