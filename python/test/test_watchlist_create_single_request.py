...
class TestWatchlistCreateSingleRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WatchlistCreateSingleRequest:
        """Test WatchlistCreateSingleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchlistCreateSingleRequest`
        """
        model = WatchlistCreateSingleRequest()
        if include_optional:
            return WatchlistCreateSingleRequest(
                item_id = 56
            )
        else:
            return WatchlistCreateSingleRequest(
    ...
    def testWatchlistCreateSingleRequest(self):
        """Test WatchlistCreateSingleRequest"""
