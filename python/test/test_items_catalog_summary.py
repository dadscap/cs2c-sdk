...
class TestItemsCatalogSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ItemsCatalogSummary:
        """Test ItemsCatalogSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsCatalogSummary`
        """
        model = ItemsCatalogSummary()
        if include_optional:
            return ItemsCatalogSummary(
                total_items = 56
            )
        else:
            return ItemsCatalogSummary(
    ...
    def testItemsCatalogSummary(self):
        """Test ItemsCatalogSummary"""
