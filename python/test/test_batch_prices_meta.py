...
class TestBatchPricesMeta(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchPricesMeta:
        """Test BatchPricesMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchPricesMeta`
        """
        model = BatchPricesMeta()
        if include_optional:
            return BatchPricesMeta(
                currency = '',
